...
import ImgLog from "../../../public/favicon.svg"
import "./navbar.css"
                    ...
                    if (!item.sub1) {
                        return (
                            <li key={`${index}-${item.name}`} className="list-unstyled">
                                {/* {item.permission ? */}
                                    <a className="dropdown-item mx-3" href={item.url}>
                                            ...
                                            return (
                                                /* element.permission ? */
                                                    <li className="d-flex justify-content-center list-unstyled" key={`${element.name}-${index2}`}>
                                                        <a className="dropdown-item d-flex justify-content-center fw-bolder text-wrap text-center item-menu-name" href={element.url}>
                                                            {element.name}
                                                        </a>
                                                    </li> 
                                                   /*  : <></> */
